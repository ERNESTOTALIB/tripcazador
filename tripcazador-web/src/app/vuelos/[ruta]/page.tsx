...
const TOP_ROUTES: Record<string, RouteEntry> = {
  ...
  // UUU01 — Bloque expansión 50→100. Mix sun-coast, ski, long-haul tier-2.
  "barcelona-estambul": {
    origin: "BCN", destination: "IST",
    originCity: "Barcelona", destCity: "Estambul",
    originLabel: "Barcelona", destLabel: "Estambul",
    intro: "Turkish, Pegasus directos. Anomalía business class regular <500€ ida.",
    bestMonths: ["abril", "mayo", "octubre"],
    emoji: "🇹🇷",
  },
  "madrid-doha": {
    origin: "MAD", destination: "DOH",
    originCity: "Madrid", destCity: "Doha",
    originLabel: "Madrid", destLabel: "Doha",
    intro: "Qatar Airways. Hub asiático con stopover 96h gratis incluyendo hotel.",
    bestMonths: ["noviembre", "febrero", "marzo"],
    emoji: "🇶🇦",
  },
  "madrid-singapur": {
    origin: "MAD", destination: "SIN",
    originCity: "Madrid", destCity: "Singapur",
    originLabel: "Madrid", destLabel: "Singapur",
    intro: "Singapore Airlines, Lufthansa. Vía FRA habitual <750€ rt economy.",
    bestMonths: ["febrero", "marzo", "noviembre"],
    emoji: "🇸🇬",
  },
  "madrid-hong-kong": {
    origin: "MAD", destination: "HKG",
    originCity: "Madrid", destCity: "Hong Kong",
    originLabel: "Madrid", destLabel: "Hong Kong",
    intro: "Cathay Pacific, Lufthansa. Anomalías error fare <600€ rt registradas en mayo y noviembre.",
    bestMonths: ["mayo", "noviembre", "marzo"],
    emoji: "🇭🇰",
  },
  "madrid-seul": {
    origin: "MAD", destination: "ICN",
    originCity: "Madrid", destCity: "Seúl",
    originLabel: "Madrid", destLabel: "Seúl",
    intro: "Korean Air, Lufthansa, Air France. Sweet spot abril (cherry blossom) + octubre (foliaje).",
    bestMonths: ["abril", "octubre", "noviembre"],
    emoji: "🇰🇷",
  },
  "madrid-shanghai": {
    origin: "MAD", destination: "PVG",
    originCity: "Madrid", destCity: "Shanghái",
    originLabel: "Madrid", destLabel: "Shanghái",
    intro: "Air China, Lufthansa. Stopovers en FRA o MUC <700€ rt regular.",
    bestMonths: ["marzo", "abril", "octubre"],
    emoji: "🇨🇳",
  },
  "madrid-melbourne": {
    origin: "MAD", destination: "MEL",
    originCity: "Madrid", destCity: "Melbourne",
    originLabel: "Madrid", destLabel: "Melbourne",
    intro: "Qatar, Emirates, Singapore. Long-haul más barato del año febrero-marzo <1100€ rt.",
    bestMonths: ["febrero", "marzo", "octubre"],
    emoji: "🇦🇺",
  },
  "madrid-sidney": {
    origin: "MAD", destination: "SYD",
    originCity: "Madrid", destCity: "Sídney",
    originLabel: "Madrid", destLabel: "Sídney",
    intro: "Qatar, Singapore, Emirates. Stopover gratis disponible Doha o Singapur.",
    bestMonths: ["mayo", "septiembre", "octubre"],
    emoji: "🇦🇺",
  },
  // Latam tier-2
  "madrid-bogota": {
    ...
    originCity: "Madrid", destCity: "Bogotá",
    originLabel: "Madrid", destLabel: "Bogotá",
    intro: "Avianca, Air Europa, Iberia. Hub a otras ciudades colombianas con conexión interna.",
    bestMonths: ["enero", "febrero", "septiembre"],
    emoji: "🇨🇴",
  },
  "madrid-santiago-chile": {
    origin: "MAD", destination: "SCL",
    originCity: "Madrid", destCity: "Santiago de Chile",
    originLabel: "Madrid", destLabel: "Santiago de Chile",
    intro: "LATAM, Iberia, Air Europa directos. Vino+gastronomía+Patagonia: 3 viajes en 1.",
    bestMonths: ["abril", "mayo", "octubre"],
    emoji: "🇨🇱",
  },
  "madrid-sao-paulo": {
    origin: "MAD", destination: "GRU",
    originCity: "Madrid", destCity: "São Paulo",
    originLabel: "Madrid", destLabel: "São Paulo",
    intro: "TAP (vía LIS), LATAM, Iberia. Conexión a Río o Salvador <50€ vuelo doméstico.",
    bestMonths: ["abril", "mayo", "septiembre"],
    emoji: "🇧🇷",
  },
  "madrid-mexico": {
    origin: "MAD", destination: "MEX",
    originCity: "Madrid", destCity: "Ciudad de México",
    originLabel: "Madrid", destLabel: "Ciudad de México",
    intro: "Iberia, Aeroméxico, Air Europa. Sweet spot febrero <500€ rt error fares posibles.",
    bestMonths: ["febrero", "septiembre", "noviembre"],
    emoji: "🇲🇽",
  },
  "madrid-rio-de-janeiro": {
    origin: "MAD", destination: "GIG",
    originCity: "Madrid", destCity: "Río de Janeiro",
    originLabel: "Madrid", destLabel: "Río de Janeiro",
    intro: "TAP (vía LIS), LATAM, Iberia. Pre-Carnaval (enero) precios mínimos.",
    bestMonths: ["mayo", "septiembre", "noviembre"],
    emoji: "🇧🇷",
  },
  // África
  "madrid-johannesburgo": {
    origin: "MAD", destination: "JNB",
    originCity: "Madrid", destCity: "Johannesburgo",
    originLabel: "Madrid", destLabel: "Johannesburgo",
    intro: "Lufthansa, KLM, Qatar. Combina con Cape Town vuelo doméstico <80€.",
    bestMonths: ["abril", "septiembre", "octubre"],
    emoji: "🇿🇦",
  },
  "madrid-ciudad-del-cabo": {
    origin: "MAD", destination: "CPT",
    originCity: "Madrid", destCity: "Ciudad del Cabo",
    originLabel: "Madrid", destLabel: "Ciudad del Cabo",
    intro: "Lufthansa, KLM. Verano sur Nov-Mar. Stopover Frankfurt o Ámsterdam.",
    bestMonths: ["marzo", "abril", "octubre"],
    emoji: "🇿🇦",
  },
  "madrid-nairobi": {
    origin: "MAD", destination: "NBO",
    originCity: "Madrid", destCity: "Nairobi",
    originLabel: "Madrid", destLabel: "Nairobi",
    intro: "Kenya Airways, KLM, Qatar. Safari + costa Mombasa: combo perfecto.",
    bestMonths: ["enero", "febrero", "octubre"],
    emoji: "🇰🇪",
  },
  "madrid-casablanca": {
    origin: "MAD", destination: "CMN",
    originCity: "Madrid", destCity: "Casablanca",
    originLabel: "Madrid", destLabel: "Casablanca",
    intro: "Royal Air Maroc, Iberia, Ryanair. Anomalías frecuentes <100€ rt.",
    bestMonths: ["marzo", "abril", "octubre"],
    emoji: "🇲🇦",
  },
  // Sun-coast & beach EU
  "madrid-malta": {
    origin: "MAD", destination: "MLA",
    originCity: "Madrid", destCity: "Malta",
    originLabel: "Madrid", destLabel: "Malta",
    intro: "Ryanair, Air Malta. Errores fare <60€ rt Sept-Mayo. Inglés oficial.",
    bestMonths: ["abril", "septiembre", "octubre"],
    emoji: "🇲🇹",
  },
  "madrid-chipre": {
    origin: "MAD", destination: "LCA",
    originCity: "Madrid", destCity: "Larnaca (Chipre)",
    originLabel: "Madrid", destLabel: "Chipre",
    intro: "Aegean, Cyprus Airways. Beach + arqueología, costo bajo. Mejor mid-week.",
    bestMonths: ["mayo", "junio", "octubre"],
    emoji: "🇨🇾",
  },
  "barcelona-malta": {
    origin: "BCN", destination: "MLA",
    originCity: "Barcelona", destCity: "Malta",
    originLabel: "Barcelona", destLabel: "Malta",
    intro: "Ryanair directo. Weekends <80€ rt habitual.",
    bestMonths: ["abril", "octubre", "noviembre"],
    emoji: "🇲🇹",
  },
  "madrid-tenerife": {
    origin: "MAD", destination: "TFS",
    originCity: "Madrid", destCity: "Tenerife",
    originLabel: "Madrid", destLabel: "Tenerife",
    intro: "Iberia, Vueling, Ryanair, Binter. Invierno cálido y precios reducidos.",
    bestMonths: ["febrero", "marzo", "noviembre"],
    emoji: "🌴",
  },
  "madrid-gran-canaria": {
    origin: "MAD", destination: "LPA",
    originCity: "Madrid", destCity: "Gran Canaria",
    originLabel: "Madrid", destLabel: "Gran Canaria",
    intro: "Iberia, Vueling, Air Europa. Vuelo doméstico, sin necesidad de pasaporte.",
    bestMonths: ["enero", "febrero", "noviembre"],
    emoji: "🌴",
  },
  "barcelona-tenerife": {
    origin: "BCN", destination: "TFS",
    originCity: "Barcelona", destCity: "Tenerife",
    originLabel: "Barcelona", destLabel: "Tenerife",
    intro: "Vueling, Ryanair, Iberia. Vuelo medio España: 3-4 horas, precio <80€ rt frecuente.",
    bestMonths: ["enero", "noviembre", "diciembre"],
    emoji: "🌴",
  },
  // Cross-EU lifecycle
  "madrid-helsinki": {
    origin: "MAD", destination: "HEL",
    originCity: "Madrid", destCity: "Helsinki",
    originLabel: "Madrid", destLabel: "Helsinki",
    intro: "Finnair, Lufthansa. Hub Asia con stopover gratis Helsinki.",
    bestMonths: ["junio", "diciembre", "marzo"],
    emoji: "🇫🇮",
  },
  "madrid-estocolmo": {
    origin: "MAD", destination: "ARN",
    originCity: "Madrid", destCity: "Estocolmo",
    originLabel: "Madrid", destLabel: "Estocolmo",
    intro: "SAS, Norwegian, Vueling. Errores fare <80€ rt registrados.",
    bestMonths: ["junio", "septiembre", "diciembre"],
    emoji: "🇸🇪",
  },
  "madrid-oslo": {
    origin: "MAD", destination: "OSL",
    originCity: "Madrid", destCity: "Oslo",
    originLabel: "Madrid", destLabel: "Oslo",
    intro: "Norwegian, SAS. Verano fjords + invierno northern lights desde Tromsø conex.",
    bestMonths: ["junio", "septiembre", "marzo"],
    emoji: "🇳🇴",
  },
  "barcelona-helsinki": {
    origin: "BCN", destination: "HEL",
    originCity: "Barcelona", destCity: "Helsinki",
    originLabel: "Barcelona", destLabel: "Helsinki",
    intro: "Finnair directos. Stopover hub Asia.",
    bestMonths: ["junio", "diciembre", "marzo"],
    emoji: "🇫🇮",
  },
  // East EU emerging
  "madrid-varsovia": {
    origin: "MAD", destination: "WAW",
    originCity: "Madrid", destCity: "Varsovia",
    originLabel: "Madrid", destLabel: "Varsovia",
    intro: "LOT, Ryanair, Wizz Air. Mid-week <60€ rt regular.",
    bestMonths: ["abril", "mayo", "octubre"],
    emoji: "🇵🇱",
  },
  "madrid-cracovia": {
    origin: "MAD", destination: "KRK",
    originCity: "Madrid", destCity: "Cracovia",
    originLabel: "Madrid", destLabel: "Cracovia",
    intro: "Ryanair directo. Histórica + Auschwitz day-trip + naturaleza.",
    bestMonths: ["abril", "mayo", "septiembre"],
    emoji: "🇵🇱",
  },
  "madrid-bucarest": {
    origin: "MAD", destination: "OTP",
    originCity: "Madrid", destCity: "Bucarest",
    originLabel: "Madrid", destLabel: "Bucarest",
    intro: "Wizz Air, Tarom, Ryanair. Errores fare <50€ rt frecuentes.",
    bestMonths: ["abril", "mayo", "septiembre"],
    emoji: "🇷🇴",
  },
  "madrid-belgrado": {
    origin: "MAD", destination: "BEG",
    originCity: "Madrid", destCity: "Belgrado",
    originLabel: "Madrid", destLabel: "Belgrado",
    intro: "Air Serbia. Vida nocturna + arquitectura austrohúngara, low budget.",
    bestMonths: ["mayo", "septiembre", "octubre"],
    emoji: "🇷🇸",
  },
  "madrid-tirana": {
    origin: "MAD", destination: "TIA",
    originCity: "Madrid", destCity: "Tirana",
    originLabel: "Madrid", destLabel: "Tirana",
    intro: "Wizz Air. Albania emergente: costa virgen + montañas <€60 rt.",
    bestMonths: ["mayo", "junio", "septiembre"],
    emoji: "🇦🇱",
  },
  "barcelona-cracovia": {
    origin: "BCN", destination: "KRK",
    originCity: "Barcelona", destCity: "Cracovia",
    originLabel: "Barcelona", destLabel: "Cracovia",
    intro: "Ryanair directo. Combina con Praga vía bus 6h <30€.",
    bestMonths: ["abril", "septiembre", "octubre"],
    emoji: "🇵🇱",
  },
  "barcelona-belgrado": {
    origin: "BCN", destination: "BEG",
    originCity: "Barcelona", destCity: "Belgrado",
    originLabel: "Barcelona", destLabel: "Belgrado",
    intro: "Air Serbia, Wizz Air. Anomalías error fare <50€ rt.",
    bestMonths: ["mayo", "septiembre", "octubre"],
    emoji: "🇷🇸",
  },
  "barcelona-bucarest": {
    origin: "BCN", destination: "OTP",
    originCity: "Barcelona", destCity: "Bucarest",
    originLabel: "Barcelona", destLabel: "Bucarest",
    intro: "Wizz Air, Ryanair. Bram Castle Drácula + Sibiu road trip.",
    bestMonths: ["abril", "mayo", "septiembre"],
    emoji: "🇷🇴",
  },
  // ES regional → EU
  "valencia-paris": {
    ...
    originCity: "Valencia", destCity: "París",
    originLabel: "Valencia", destLabel: "París",
    intro: "Vueling, Air France. Mid-week <80€ rt regular.",
    bestMonths: ["abril", "mayo", "octubre"],
    emoji: "🇫🇷",
  },
  "valencia-amsterdam": {
    origin: "VLC", destination: "AMS",
    originCity: "Valencia", destCity: "Ámsterdam",
    originLabel: "Valencia", destLabel: "Ámsterdam",
    intro: "Transavia, KLM. Errores fare <60€ rt frecuentes.",
    bestMonths: ["abril", "septiembre", "octubre"],
    emoji: "🇳🇱",
  },
  "sevilla-paris": {
    origin: "SVQ", destination: "PAR",
    originCity: "Sevilla", destCity: "París",
    originLabel: "Sevilla", destLabel: "París",
    intro: "Vueling, Ryanair (vía BVA). Mid-week <70€ rt regular.",
    bestMonths: ["abril", "mayo", "octubre"],
    emoji: "🇫🇷",
  },
  "sevilla-amsterdam": {
    origin: "SVQ", destination: "AMS",
    originCity: "Sevilla", destCity: "Ámsterdam",
    originLabel: "Sevilla", destLabel: "Ámsterdam",
    intro: "Transavia, Vueling. Anomalías <60€ rt.",
    bestMonths: ["abril", "septiembre", "octubre"],
    emoji: "🇳🇱",
  },
  "bilbao-amsterdam": {
    origin: "BIO", destination: "AMS",
    originCity: "Bilbao", destCity: "Ámsterdam",
    originLabel: "Bilbao", destLabel: "Ámsterdam",
    intro: "KLM, Vueling. Combo norte ES + tulipanes Holanda.",
    bestMonths: ["abril", "septiembre", "octubre"],
    emoji: "🇳🇱",
  },
  "bilbao-roma": {
    origin: "BIO", destination: "ROM",
    originCity: "Bilbao", destCity: "Roma",
    originLabel: "Bilbao", destLabel: "Roma",
    intro: "Vueling, ITA. Mid-week <70€ rt regular.",
    bestMonths: ["abril", "mayo", "octubre"],
    emoji: "🇮🇹",
  },
  "malaga-roma": {
    origin: "AGP", destination: "ROM",
    originCity: "Málaga", destCity: "Roma",
    originLabel: "Málaga", destLabel: "Roma",
    intro: "Vueling, Ryanair. Mid-week <60€ rt frecuente.",
    bestMonths: ["abril", "mayo", "octubre"],
    emoji: "🇮🇹",
  },
  // Cross EU non-capital
  "milan-barcelona": {
    origin: "MIL", destination: "BCN",
    originCity: "Milán", destCity: "Barcelona",
    originLabel: "Milán", destLabel: "Barcelona",
    intro: "Vueling, Ryanair, EasyJet. Mid-week <40€ rt habitual.",
    bestMonths: ["abril", "mayo", "octubre"],
    emoji: "🇪🇸",
  },
  "praga-paris": {
    origin: "PRG", destination: "PAR",
    originCity: "Praga", destCity: "París",
    originLabel: "Praga", destLabel: "París",
    intro: "Smartwings, Air France. <70€ rt regular.",
    bestMonths: ["abril", "mayo", "septiembre"],
    emoji: "🇫🇷",
  },
  "amsterdam-paris": {
    origin: "AMS", destination: "PAR",
    originCity: "Ámsterdam", destCity: "París",
    originLabel: "Ámsterdam", destLabel: "París",
    intro: "KLM, Air France, Transavia. Tren Thalys alternativa 3h20m.",
    bestMonths: ["abril", "mayo", "octubre"],
    emoji: "🇫🇷",
  },
};

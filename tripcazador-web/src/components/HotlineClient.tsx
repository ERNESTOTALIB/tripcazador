...
/**
 * HotlineClient — SSS372 (21 may 2026)
 *
 * UI cliente para /premium/hotline. Acepta texto (mic en iteración 2 si
 * navegador soporta Web Speech API). Llama /api/voice/hotline y renderiza
 * la respuesta + reproduce audio si la API lo devuelve.
 */

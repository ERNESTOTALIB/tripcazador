...
AIRPORT_GEO = {
    ...
    "STI": ("Santiago de los Caballeros", "República Dominicana", "Caribe"),
    ...
    "BGI": ("Bridgetown",   "Barbados",        "Caribe"),
...
# ── Expansión abril 2026: +100 aeropuertos (ver airports.ts frontend) ──
AIRPORT_GEO.update({
    # Islas griegas + Balcanes
    "SMI": ("Samos", "Grecia", "Europa"),
    "MJT": ("Mitilene", "Grecia", "Europa"),
    "PVK": ("Preveza", "Grecia", "Europa"),
    "BOJ": ("Burgas", "Bulgaria", "Europa"),
    "TGD": ("Podgorica", "Montenegro", "Europa"),
    "SJJ": ("Sarajevo", "Bosnia y Herzegovina", "Europa"),
    "TSR": ("Timișoara", "Rumanía", "Europa"),
    # Bálticos
    "KUN": ("Kaunas", "Lituania", "Europa"),
    "PLQ": ("Palanga", "Lituania", "Europa"),
    # Cáucaso
    "BUS": ("Batumi", "Georgia", "Asia"),
    # Europa regional
    "TRS": ("Trieste", "Italia", "Europa"),
    "AGB": ("Augsburgo", "Alemania", "Europa"),
    "SPC": ("La Palma", "España", "Europa"),
    "TER": ("Terceira", "Portugal", "Europa"),
    "AJA": ("Ajaccio", "Francia", "Europa"),
    "BZR": ("Béziers", "Francia", "Europa"),
    "EBU": ("Saint-Étienne", "Francia", "Europa"),
    "PGF": ("Perpiñán", "Francia", "Europa"),
    "BES": ("Brest", "Francia", "Europa"),
    "TLN": ("Toulon", "Francia", "Europa"),
    "FNI": ("Nîmes", "Francia", "Europa"),
    "LDE": ("Lourdes/Tarbes", "Francia", "Europa"),
    "RNS": ("Rennes", "Francia", "Europa"),
    "LIL": ("Lille", "Francia", "Europa"),
    "ABZ": ("Aberdeen", "Reino Unido", "Europa"),
    "BFS": ("Belfast Int.", "Reino Unido", "Europa"),
    "BHD": ("Belfast City", "Reino Unido", "Europa"),
    "LBA": ("Leeds Bradford", "Reino Unido", "Europa"),
    "EMA": ("East Midlands", "Reino Unido", "Europa"),
    "SOU": ("Southampton", "Reino Unido", "Europa"),
    "MJV": ("Murcia", "España", "Europa"),
    # Escandinavia
    "MOL": ("Molde", "Noruega", "Europa"),
    "TOS": ("Tromsø", "Noruega", "Europa"),
    "KRS": ("Kristiansand", "Noruega", "Europa"),
    "SVG": ("Stavanger", "Noruega", "Europa"),
    "AES": ("Ålesund", "Noruega", "Europa"),
    "LPI": ("Linköping", "Suecia", "Europa"),
    "UME": ("Umeå", "Suecia", "Europa"),
    "LLA": ("Luleå", "Suecia", "Europa"),
    "KRN": ("Kiruna", "Suecia", "Europa"),
    "TKU": ("Turku", "Finlandia", "Europa"),
    "OUL": ("Oulu", "Finlandia", "Europa"),
    "TMP": ("Tampere", "Finlandia", "Europa"),
    "RVN": ("Rovaniemi", "Finlandia", "Europa"),
    "IVL": ("Ivalo", "Finlandia", "Europa"),
    "KGD": ("Kaliningrado", "Rusia", "Europa"),
    "AER": ("Sochi", "Rusia", "Europa"),
    # EEUU ampliación
    "HOU": ("Houston Hobby", "EE. UU.", "América Norte"),
    "AUS": ("Austin", "EE. UU.", "América Norte"),
    "MEM": ("Memphis", "EE. UU.", "América Norte"),
    "ELP": ("El Paso", "EE. UU.", "América Norte"),
    "SLC": ("Salt Lake City", "EE. UU.", "América Norte"),
    "BOI": ("Boise", "EE. UU.", "América Norte"),
    "OKC": ("Oklahoma City", "EE. UU.", "América Norte"),
    "RSW": ("Fort Myers", "EE. UU.", "América Norte"),
    "JAX": ("Jacksonville", "EE. UU.", "América Norte"),
    "CHS": ("Charleston", "EE. UU.", "América Norte"),
    "BTV": ("Burlington", "EE. UU.", "América Norte"),
    "BUF": ("Búfalo", "EE. UU.", "América Norte"),
    "RDU": ("Raleigh-Durham", "EE. UU.", "América Norte"),
    "PNS": ("Pensacola", "EE. UU.", "América Norte"),
    # México / Centroamérica
    "HMO": ("Hermosillo", "México", "América Norte"),
    "MID": ("Mérida", "México", "América Norte"),
    "OAX": ("Oaxaca", "México", "América Norte"),
    "SAL": ("San Salvador", "El Salvador", "América Norte"),
    "TGU": ("Tegucigalpa", "Honduras", "América Norte"),
    "GEO": ("Georgetown", "Guyana", "América Sur"),
    "PBM": ("Paramaribo", "Surinam", "América Sur"),
    # Sudamérica ampliación
    "MZA": ("Mendoza", "Argentina", "América Sur"),
    "BRC": ("Bariloche", "Argentina", "América Sur"),
    "FTE": ("El Calafate", "Argentina", "América Sur"),
    "AQP": ("Arequipa", "Perú", "América Sur"),
    "SMR": ("Santa Marta", "Colombia", "América Sur"),
    "CLO": ("Cali", "Colombia", "América Sur"),
    "BAQ": ("Barranquilla", "Colombia", "América Sur"),
    # Caribe
    "BON": ("Bonaire", "Países Bajos caribeños", "Caribe"),
    # SXM definido arriba con ("Sint Maarten", "Sint Maarten", "Caribe") —
    # no duplicar aquí para evitar overrides silenciosos en el dict.
    "ANU": ("Antigua", "Antigua y Barbuda", "Caribe"),
    "SKB": ("Saint Kitts", "San Cristóbal y Nieves", "Caribe"),
    "DOM": ("Dominica", "Dominica", "Caribe"),
    "GND": ("Granada (Caribe)", "Granada", "Caribe"),
    "FDF": ("Fort-de-France", "Martinica", "Caribe"),
    "PTP": ("Pointe-à-Pitre", "Guadalupe", "Caribe"),
    "POP": ("Puerto Plata", "República Dominicana", "Caribe"),
    "LRM": ("La Romana", "República Dominicana", "Caribe"),
    "POS": ("Puerto España", "Trinidad y Tobago", "Caribe"),
    "PLS": ("Providenciales", "Islas Turcas y Caicos", "Caribe"),
    "FPO": ("Freeport", "Bahamas", "Caribe"),
    "CAY": ("Cayena", "Guayana Francesa", "América Sur"),
    # Asia Pacífico ampliación
    "SDJ": ("Sendai", "Japón", "Asia"),
    "HIJ": ("Hiroshima", "Japón", "Asia"),
    "FSZ": ("Shizuoka", "Japón", "Asia"),
    "OKJ": ("Okayama", "Japón", "Asia"),
    "CJU": ("Jeju", "Corea del Sur", "Asia"),
    "TAE": ("Daegu", "Corea del Sur", "Asia"),
    "GOH": ("Nuuk", "Groenlandia", "América Norte"),
    # África ampliación
    "DLA": ("Duala", "Camerún", "África"),
    "NSI": ("Yaundé", "Camerún", "África"),
    "LBV": ("Libreville", "Gabón", "África"),
    "APL": ("Nampula", "Mozambique", "África"),
    # Oceanía adicional
    "HBA": ("Hobart", "Australia", "Oceanía"),
    "LST": ("Launceston", "Australia", "Oceanía"),
    "OOL": ("Gold Coast", "Australia", "Oceanía"),
    "MCY": ("Sunshine Coast", "Australia", "Oceanía"),
})

...
export const CONCIERGE_TIERS: Record<ConciergeTier, TierDefinition> = {
  ...
  standard: {
    ...
    delivery_hours: 24,
    delivery_label: "Entrega en 24h",
    tagline: "Tu propuesta vuelo+hotel en 24h o te devolvemos el dinero",
    bullets: [
      "Respuesta en menos de 24h (no 48h)",
      "5 opciones combinadas vuelo + hotel sugerido",
      "Tips destino (mejor zona, transporte, packing)",
      "Si encuentras una opción mejor en otra plataforma, te devolvemos los €19",
    ],
    popular: true,

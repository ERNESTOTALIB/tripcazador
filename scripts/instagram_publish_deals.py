...
def generate_and_upload_carousel(deal: Dict[str, Any]) -> Optional[List[str]]:
    ...
    _DEST_ALIASES = {
        ...
        # SSS87: nuevas ciudades del catalog expandido
        "rome": "roma",
        "roma italia": "roma",
        "paris france": "paris",
        "paris francia": "paris",
        ...
        "dublin irlanda": "dublin",
        "madrid spain": "madrid",
        "madrid espana": "madrid",
    ...
    _UNSPLASH_BY_CITY = {
        ...
        "berlin": "1567593810070-7a3d471af022",
        ...
        # SSS87: nuevas ciudades del catalog expandido
        "atenas": "1518543237-50da9deab98b",
        "viena": "1500382017468-9049fed747ef",
        "budapest": "1551867633-194f125bddfa",
        "dublin": "1564594028516-e15c4e3eba81",

...
export const AIRLINE_COMPARISONS: AirlineComparison[] = [
  ...
  // ─── 36. Iberia vs Air Europa Latam Business (MAD hub batalla) ───────
  {
    slug: "iberia-vs-aireuropa-latam-business",
    title: "Iberia vs Air Europa Madrid-Latam Business 2026: cuál batir",
    description:
      "Comparativa Iberia vs Air Europa en business class MAD-Latam 2026: precios reales BUE/SCL/LIM/EZE/GIG, error fares €1.400-1.900 rt, Avios vs SUMA. Decisión cazador.",
    routeContext: "MAD-Latam business class (BUE/EZE/SCL/LIM/BOG/GRU/CUN)",
    a: {
      code: "IB",
      name: "Iberia",
      country: "España",
      emoji: "🇪🇸",
      category: "full-service",
      tagline: "Bandera nacional, hub MAD, líder Latam Oneworld",
      mainHub: "MAD",
      typicalPriceEur: 2600,
      minErrorFareEur: 1450,
      loyaltyProgram: "Iberia Plus / Avios (Oneworld)",
      skytraxStars: 4,
    },
    b: {
      code: "UX",
      ...
      emoji: "🇪🇸",
      category: "full-service",
      tagline: "Hub MAD SkyTeam, fortaleza Caribe + Cono Sur",
      mainHub: "MAD",
      typicalPriceEur: 2200,
      minErrorFareEur: 1180,
      loyaltyProgram: "Air Europa SUMA / Flying Blue (SkyTeam)",
      skytraxStars: 3,
    },
    criteria: [
      { label: "Precio típico business rt MAD-Latam", aScore: 6, bScore: 8, winner: "b", note: "Iberia €2.400-2.900 rt MAD-EZE/SCL Business. UX €1.900-2.500 misma ruta. UX 12-18% más barato típicamente" },
      { label: "Producto cabina business", aScore: 9, bScore: 7, winner: "a", note: "Iberia Business Plus A350: 1-2-1 lie-flat consistente toda flota long-haul + Cosme Beccar amenity kit. UX A330: 2-2-2 mixta (algunos aviones 1-2-1)" },
      { label: "Red Latam continental", aScore: 9, bScore: 7, winner: "a", note: "Iberia: 18 destinos Latam directos diarios (BUE, EZE, SCL, LIM, BOG, GRU, MEX, CUN, GUA, SDQ, HAV...). UX: 11 destinos (foco Caribe + Argentina + Brasil)" },
      { label: "Frecuencia error fares business", aScore: 7, bScore: 9, winner: "b", note: "UX pricing engine ES-Latam glitches frecuentes Business €1.180-1.600 rt 4-6×/año (BUE, EZE, MEX). Iberia más estable, errors raros (€1.450 mín 2024-25)" },
      { label: "Lounges MAD T4 Business", aScore: 9, bScore: 5, winner: "a", note: "Iberia Velázquez Lounge T4S brutal (champagne + spa + ducha + sleep pods). UX usa lounge SkyTeam más básico en MAD T1" },
      { label: "Programa Avios vs SUMA premium use", aScore: 9, bScore: 6, winner: "a", note: "Avios sweet spot 68k pts MAD-BUE Business one-way. SUMA tiene mejor terrestre pero peor uso premium internacional (necesita Flying Blue transfer)" },
      { label: "Puntualidad long-haul", aScore: 8, bScore: 6, winner: "a", note: "Iberia 87% on-time long-haul 2025. UX 79% (peor connection performance en hub MAD)" },
    ],
    verdict:
      "Iberia gana en producto cabina (1-2-1 consistente), red Latam continental (18 destinos directos), lounge MAD Velázquez (top 5 mundo) y Avios para uso premium Oneworld (BA, AA, QR). Air Europa gana en precio Business (-12-18% típico) y frecuencia de error fares ES-Latam Business (€1.180-1.600 rt 4-6×/año). Si el objetivo es 'business Latam ahora y precio importa' → UX (más barato y errors frecuentes). Si vas a destino que UX no opera (LIM, BOG, MEX vía SkyTeam dependes de codeshare) o quieres acumular Avios usables en Oneworld → Iberia. Para Argentina/Chile/Brasil ambos compiten cabeza a cabeza, decisión por error fare del momento.",
    pickA: [
      "Destinos sin operación UX (LIM, BOG, GUA, SDQ Iberia directo)",
      "Acumular Avios premium para uso Oneworld",
      "Lounge MAD T4S Velázquez (champagne + spa + dormir)",
      "Puntualidad importa (conexión post-Latam)",
    ],
    pickB: [
      "Precio Business importa (-12-18% vs Iberia)",
      "Cazar error fare UX-Latam Business €1.180-1.600 rt",
      "Caribe puro (Punta Cana, Cancún, La Habana foco UX)",
      "Flying Blue transfer points desde Amex/Marriott",
    ],
  },
  // ─── 37. Vueling vs Ryanair Londres (rutas BCN/MAD-LON específicas) ──
  {
    slug: "vueling-vs-ryanair-londres",
    title: "Vueling vs Ryanair Londres 2026: BCN/MAD-LHR/STN/LTN comparado",
    description:
      "Comparativa Vueling vs Ryanair en rutas Londres específicas 2026: BCN/MAD-LHR/LGW/STN/LTN, equipaje, frecuencia, aeropuerto centro. Decisión por viajero.",
    routeContext: "BCN/MAD-Londres (LHR/LGW/STN/LTN)",
    a: {
      code: "VY",
      name: "Vueling",
      country: "España",
      emoji: "🐦",
      category: "low-cost",
      tagline: "Low-cost IAG, hub BCN, vuela a Heathrow y Gatwick",
      mainHub: "BCN",
      typicalPriceEur: 110,
      minErrorFareEur: 29,
      loyaltyProgram: "Vueling Club / Avios (Oneworld)",
      skytraxStars: 3,
    },
    b: {
      code: "FR",
      ...
      emoji: "🇮🇪",
      category: "low-cost",
      tagline: "Low-cost duro, hub STN, vuela a Stansted y Luton",
      mainHub: "STN",
      typicalPriceEur: 75,
      minErrorFareEur: 19,
      loyaltyProgram: "Ryanair Wallet (poco competitivo)",
    ...
    criteria: [
      { label: "Precio típico rt BCN/MAD-LON", aScore: 6, bScore: 9, winner: "b", note: "Vueling €90-160 rt típico BCN-LHR/LGW. Ryanair €50-130 rt BCN/MAD-STN/LTN. Ryanair 25-35% más barato típicamente" },
      { label: "Aeropuerto destino Londres", aScore: 9, bScore: 5, winner: "a", note: "Vueling vuela LHR (Heathrow) + LGW (Gatwick) — ambos con tren directo centro 15-30min (LHR Express £25, Gatwick Express £25). Ryanair STN (Stansted) tren £25 + 50min, LTN (Luton) bus £15 + 70min. Vueling ahorra 30-45min y €0-10 transporte" },
      { label: "Frecuencia diaria", aScore: 8, bScore: 9, winner: "b", note: "Vueling: 6-8 frecuencias/día BCN-LHR/LGW + 4 MAD-LGW. Ryanair: 8-12 frecuencias/día BCN/MAD-STN/LTN (más opciones, peor horario madrugada/noche)" },
      { label: "Equipaje cabina incluido", aScore: 5, bScore: 4, winner: "a", note: "Vueling Basic: 1 bolso bajo asiento + opción 10kg overhead +€11-15. Ryanair Basic: solo 1 bolso pequeño. Vueling más flexible en cabina" },
      { label: "Puntualidad rutas Londres 2025", aScore: 6, bScore: 7, winner: "b", note: "Ryanair 84% on-time BCN/MAD-STN/LTN (operación tightly run). Vueling 76% BCN/MAD-LHR/LGW (afectada por slots LHR limitados)" },
      { label: "Política familias (asientos juntos)", aScore: 6, bScore: 3, winner: "a", note: "Vueling permite hasta 2 personas en mismo PNR mantener asientos sin paid seat. Ryanair separa familias agresivamente para forzar +€8-12/asiento" },
      { label: "Avios accumulation (Oneworld)", aScore: 9, bScore: 1, winner: "a", note: "Vueling acumula Avios (Vueling Club, transferible BA/Iberia). Ryanair: cero loyalty útil internacional" },
    ],
    verdict:
      "Ryanair gana en precio puro (-25-35% típico) y frecuencia diaria (más opciones horarias). Vueling gana en aeropuerto destino (LHR/LGW ambos centrales con tren directo), política familias (no separa parejas sin pagar), equipaje cabina más flexible y acumulación Avios canjeables. Si vas solo o pareja sin equipaje y aeropuerto secundario te da igual → Ryanair (€20-50 ahorro real). Si vas con familia, llevas equipaje cabina importante, valoras tren directo centro Londres en 15-30min, o quieres acumular Avios para uso Oneworld → Vueling (€20-50 extra justificados). Ratio coste-tiempo: Vueling ahorra 30-45min en transporte centro Londres + €5-10 en billete tren vs Ryanair STN/LTN, lo que compensa parcialmente el sobreprecio.",
    pickA: [
      "Llegada Heathrow/Gatwick (15-30min centro tren directo)",
      "Viaje en familia (asientos juntos sin pagar)",
      "Equipaje cabina 10kg importante",
      "Acumular Avios (Vueling Club → BA/Iberia transferibles)",
    ],
    pickB: [
      "Precio mínimo absoluto (-25-35% típico vs Vueling)",
      "Stansted/Luton aceptables (50-70min centro bus/tren)",
      "Solo mochila bajo asiento sin equipaje extra",
      "Travel hacking error fares €19-39 BCN/MAD-STN rt",
    ],
  },
  // ─── 38. Cathay vs Singapore Business Asia (Long-haul premium) ───────
  {
    slug: "cathay-vs-singapore-business-asia",
    title: "Cathay Pacific vs Singapore Airlines Business 2026: Asia premium",
    description:
      "Comparativa Cathay Pacific vs Singapore Airlines en business class Europa-Asia 2026: Cathay Business Suite vs SQ Business 2013, lounges, comida, error fares €1.800-2.400 rt.",
    routeContext: "Europa-Asia long-haul business (HKG/SIN hubs)",
    a: {
      code: "CX",
      name: "Cathay Pacific",
      country: "Hong Kong",
      emoji: "🇭🇰",
      category: "luxury",
      tagline: "Skytrax 5★, hub HKG, gold standard Oneworld Asia",
      mainHub: "HKG",
      typicalPriceEur: 3200,
      minErrorFareEur: 1850,
      loyaltyProgram: "Asia Miles + Cathay Marco Polo Club (Oneworld)",
      skytraxStars: 5,
    },
    b: {
      code: "SQ",
      ...
      emoji: "🇸🇬",
      category: "luxury",
      tagline: "Skytrax World #1 2024, hub SIN, Suites + A380 fleet",
      mainHub: "SIN",
      typicalPriceEur: 3400,
      minErrorFareEur: 2050,
      loyaltyProgram: "KrisFlyer (Star Alliance)",
      skytraxStars: 5,
    },
    criteria: [
      { label: "Business class producto (no Suites)", aScore: 9, bScore: 8, winner: "a", note: "Cathay Business 1-2-1 lie-flat en A350/777-300ER con privacidad media, almohada Bamford amenity. SQ Business 1-2-1 (avión 2013-design en A380/A350) — espacioso pero menos privado, sin puerta. Cathay edge en privacidad" },
      { label: "Cabina First-Class / Suites", aScore: 8, bScore: 10, winner: "b", note: "Cathay First 1-1-1 (A350) muy buena pero discontinuada en 777-300ER 2024. SQ Suites A380 (icono mundial): cabina cerrada con puerta + cama matrimonial doble + champagne Krug. SQ Suites referencia luxury aviación" },
      { label: "Lounge hub flagship", aScore: 9, bScore: 9, winner: "tie", note: "Cathay The Wing/The Pier HKG: cabanas privadas + duchas + Champagne Krug. SQ The Private Room SIN (solo Suites/First): cocina à la carte + champagne. Ambos top 5 mundo, empate" },
      { label: "Red destinos Asia", aScore: 8, bScore: 9, winner: "b", note: "Cathay desde HKG: 70+ destinos Asia/Pacífico (fortaleza China continental + Indochina). SQ desde SIN: 80+ destinos Asia (fortaleza Sudeste Asia + India + Australia). SQ red más amplia" },
      { label: "Frecuencia error fares Business", aScore: 9, bScore: 7, winner: "a", note: "Cathay publica errors Business Europa-HKG/Asia €1.850-2.400 rt 5-7×/año (MAD/BCN/CDG/AMS/FRA). SQ más estable, errors raros (€2.050-2.600 mín 2024-25)" },
      { label: "Conexión vía hub Asia", aScore: 8, bScore: 9, winner: "b", note: "HKG: 60min mín conexión, 2 terminales conectadas tren. SIN Changi: 50min mín, top airport mundo 8 años seguidos (atracciones + jardín + cine + pool gratis en transit)" },
      { label: "Precio típico business rt Europa-Asia", aScore: 8, bScore: 7, winner: "a", note: "Cathay €2.900-3.500 rt típico MAD/BCN-BKK/SIN/HKG Business. SQ €3.100-3.800 misma ruta. Cathay 5-10% más barato típicamente + error fares frecuentes" },
      { label: "Oneworld vs Star Alliance status", aScore: 9, bScore: 9, winner: "tie", note: "Cathay Marco Polo elite reconocido BA/IB/QR/JL (Oneworld). SQ KrisFlyer elite reconocido LH/UA/AC/TG (Star Alliance). Ambos top status, empate" },
    ],
    verdict:
      "Cathay Pacific gana en privacidad Business (clase 1-2-1 con privacidad superior), error fares frecuentes Europa-Asia (€1.850-2.400 rt 5-7×/año), precio Business 5-10% menor y red China continental dominante. Singapore Airlines gana en Suites A380 (referencia luxury mundial), red Sudeste Asia + India + Oceanía, Changi como hub (top mundial 8 años), KrisFlyer para canje Star Alliance (LH, UA, AC, TG). Si target es Business + precio importa + error fares frecuentes → Cathay (€200-400 ahorro típico + 5-7 errors/año). Si target es First/Suites o conectar Australia/Oceanía/India + valor Changi como destino transit → Singapore. Para BKK/SIN/HKG ambos compiten cabeza a cabeza, decisión por error fare del momento + alianza preferida.",
    pickA: [
      "Business class privacidad importa (Cathay 1-2-1 superior)",
      "Cazar error fare Business €1.850-2.400 rt (5-7×/año)",
      "Destinos China continental (PEK, PVG, CAN, CTU)",
      "Status Oneworld (BA, IB, AA, QR, JL canjeable)",
    ],
    pickB: [
      "Suites A380 referencia luxury (SIN-LHR/CDG/FRA/SYD)",
      "Destinos Sudeste Asia + India + Australia (foco SQ)",
      "Changi como destino transit (top airport mundo)",
      "Status Star Alliance (LH, UA, AC, TG canjeable)",
    ],
  },
  // SSS293 (18 may 2026): +5 comparisons (38→43)
  {
    slug: "wizz-vs-ryanair-este-europa",
    title: "Wizz Air vs Ryanair: ¿cuál es mejor para volar al Este de Europa?",
    description: "Comparativa Wizz Air vs Ryanair para destinos Polonia, Hungría, Rumanía, Bulgaria. Hubs, error fares, equipaje y experiencia a bordo.",
    routeContext: "España → Polonia/Hungría/Rumanía/Bulgaria",
    a: {
      code: "W6",
      name: "Wizz Air",
      country: "Hungría",
      emoji: "🟣",
      category: "low-cost",
      tagline: "Especialista Este Europa con hubs en BUD/WAW/OTP/KTW",
      mainHub: "BUD",
      typicalPriceEur: 95,
      minErrorFareEur: 22,
    ...
    b: {
      ...
      emoji: "🟦",
      category: "low-cost",
      tagline: "Mayor low-cost Europa, 200+ rutas desde España",
      mainHub: "DUB",
      typicalPriceEur: 105,
      minErrorFareEur: 18,
      loyaltyProgram: "Sin programa formal",
      skytraxStars: 3,
    },
    criteria: [
      { label: "Red destinos Este Europa", aScore: 9, bScore: 6, winner: "a", note: "Wizz tiene 30+ destinos Polonia/Hungría/Rumanía/Bulgaria/Ucrania desde ES. Ryanair cubre menos (~12) con hubs principalmente UK/IT" },
      { label: "Frecuencia error fares ES→Este", aScore: 8, bScore: 7, winner: "a", note: "Wizz 4-6 errors/año ES-WAW/BUD/OTP €22-35 rt. Ryanair 3-4 errors similar rango" },
      { label: "Estrictez equipaje gate fee", aScore: 5, bScore: 4, winner: "a", note: "Wizz gate fee €80 vs Ryanair €75. Wizz bolso 40×30×20 más generoso ancho. Ryanair 40×20×25 (más estricto)" },
      { label: "Experiencia a bordo", aScore: 5, bScore: 4, winner: "a", note: "Wizz asientos ligeramente más cómodos. Ryanair más espartano. Ambos sin snack incluido" },
      { label: "Puntualidad operativa", aScore: 7, bScore: 7, winner: "tie", note: "Ambos 78-82% on-time. Wizz más afectado por huelgas Este Europa. Ryanair más afectado por huelgas FR/IT" },
      { label: "Precio ida típica BCN-WAW", aScore: 8, bScore: 7, winner: "a", note: "Wizz €45-60 ida BCN-WAW típico. Ryanair €55-70 misma ruta (vía MXP a veces). Wizz directo gana €10-15" },
      { label: "Política cambio fecha", aScore: 6, bScore: 5, winner: "a", note: "Wizz cambio fecha €40 + diff tarifa. Ryanair €60 + diff (más caro)" },
    ],
    verdict: "Para destinos Este Europa (Polonia, Hungría, Rumanía, Bulgaria), Wizz Air es claramente la mejor opción: red más densa, precios típicamente €10-15 más baratos, error fares 4-6 veces al año. Ryanair compete solo si tu ruta específica (ej BCN-Cracovia) la opera ambos — comparar siempre. Para destinos UK/Irlanda/Italia, Ryanair gana por red más amplia. Para Polonia/Hungría/Rumanía → Wizz casi siempre.",
    pickA: ["Polonia (WAW, KRK, GDN, KTW)", "Hungría (BUD)", "Rumanía (OTP, CLJ, IAS)", "Bulgaria (SOF, VAR, BOJ)"],
    pickB: ["UK (LGW, STN, LPL, EDI)", "Irlanda (DUB, ORK, SNN)", "Italia (BGY, CIA, PSA)"],
  },
  {
    slug: "turkish-vs-aegean-grecia",
    title: "Turkish Airlines vs Aegean: ¿cuál para Grecia desde España?",
    description: "Comparativa Turkish Airlines vs Aegean para volar a Atenas/Estambul. Producto a bordo, escalas, error fares y programa fidelidad.",
    routeContext: "España → Atenas/Estambul/Heraklion",
    a: {
      code: "TK",
      name: "Turkish Airlines",
      country: "Turquía",
      emoji: "🟥",
      category: "luxury",
      tagline: "Hub IST conecta Europa-Asia, Star Alliance, Skytrax 5★",
      mainHub: "IST",
      typicalPriceEur: 220,
      minErrorFareEur: 85,
      loyaltyProgram: "Miles&Smiles (Star Alliance)",
    ...
    b: {
      ...
      emoji: "🟦",
      category: "full-service",
      tagline: "Bandera griega, hub ATH, Star Alliance también",
      mainHub: "ATH",
      typicalPriceEur: 195,
      minErrorFareEur: 78,
      loyaltyProgram: "Miles&Bonus (Star Alliance)",
    ...
    criteria: [
      { label: "Vuelo directo MAD/BCN-ATH", aScore: 4, bScore: 9, winner: "b", note: "Aegean MAD-ATH directo 3 frecuencias/día. Turkish requiere conexión vía IST (+3h). Para Grecia directo gana Aegean" },
      { label: "Vuelo directo MAD/BCN-IST", aScore: 9, bScore: 3, winner: "a", note: "Turkish MAD-IST + BCN-IST directos diarios. Aegean requiere conexión vía ATH. Para Estambul → Turkish" },
      { label: "Producto cabina Economy", aScore: 9, bScore: 7, winner: "a", note: "Turkish Economy: comida real + kit aseo + entretenimiento extenso. Aegean Economy: snack + drink + entretenimiento básico. Turkish edge clase Premium feel" },
      { label: "Error fares ES-ATH/IST", aScore: 8, bScore: 7, winner: "a", note: "Turkish errors 4-5/año MAD-IST €85-130 rt. Aegean errors 2-3/año MAD-ATH €78-110. Turkish más frecuente" },
      { label: "Red islas griegas (Mykonos, Santorini, Rodas)", aScore: 5, bScore: 9, winner: "b", note: "Aegean conecta ATH con todas las islas (40+ destinos). Turkish requiere doble conexión (IST-ATH-isla). Aegean dominante en islas" },
      { label: "Equipaje incluido", aScore: 9, bScore: 7, winner: "a", note: "Turkish Economy: 30kg facturados + 8kg cabina. Aegean Economy: 23kg facturados + 8kg cabina. Turkish 30% más generoso" },
      { label: "Hub experience", aScore: 9, bScore: 6, winner: "a", note: "IST nuevo aeropuerto top-tier (2019, mejor del mundo Skytrax 2024). ATH viejo pero funcional. Turkish hub edge" },
    ],
    verdict: "Para destinos islas griegas (Mykonos, Santorini, Rodas, Heraklion, Corfu, Creta) Aegean gana fácil — vuelos directos vía ATH + red densa interislas. Para Estambul o conexiones Asia, Turkish gana — directo + hub mejor. Para Atenas específicamente: Aegean directo es más rápido y barato típicamente. Para combinaciones España → Grecia + Turquía + Egipto, Turkish gana por hub flexibility en IST.",
    pickA: ["Estambul directo (TK MAD-IST)", "Conexiones a Asia (BKK, NRT, DXB via IST)", "Producto a bordo top-tier Economy", "Acumular millas Miles&Smiles + Star Alliance"],
    pickB: ["Atenas directo (A3 MAD-ATH)", "Islas griegas (40+ destinos)", "Stopover ATH 1-2 noches", "Acumular Miles&Bonus (más fácil status oro)"],
  },
  {
    slug: "emirates-vs-etihad-dubai-abu-dhabi",
    title: "Emirates vs Etihad: ¿hub Dubai o Abu Dhabi?",
    description: "Comparativa Emirates (DXB) vs Etihad (AUH) para conexiones Europa-Asia/Oceanía. Producto, error fares, stopover y experiencia.",
    routeContext: "España → Asia/Oceanía vía Golfo",
    a: {
      code: "EK",
      name: "Emirates",
      ...
      emoji: "🟫",
      category: "luxury",
      tagline: "Mayor red mundial A380, hub DXB, ICE entertainment top",
      mainHub: "DXB",
      typicalPriceEur: 680,
      minErrorFareEur: 320,
      loyaltyProgram: "Skywards",
    ...
    b: {
      ...
      emoji: "🟧",
      category: "luxury",
      tagline: "Apartment/Residence Business, hub AUH, partnership AF-KLM",
      mainHub: "AUH",
      typicalPriceEur: 620,
      minErrorFareEur: 280,
      loyaltyProgram: "Etihad Guest",
    ...
    criteria: [
      { label: "Red destinos mundiales", aScore: 10, bScore: 7, winner: "a", note: "Emirates 140+ destinos, fortaleza Asia + Oceanía + África. Etihad 70+ destinos, foco Asia + Sudeste Asia. EK red 2× más amplia" },
      { label: "Producto Business class", aScore: 8, bScore: 10, winner: "b", note: "Emirates Business A380 muy bueno (bar a bordo). Etihad Apartment (4m² + ducha en First) referencia mundial luxury. EY edge en producto premium" },
      { label: "Error fares Europa-Asia", aScore: 8, bScore: 9, winner: "b", note: "Emirates 4-6 errors/año MAD-BKK/SIN €320-450 rt. Etihad 6-8 errors/año MAD-BKK €280-400. Etihad más volátil pricing engine" },
      { label: "Stopover programme gratis", aScore: 9, bScore: 7, winner: "a", note: "Emirates Dubai Stopover: hotel + visa + transfer gratis 96h (muchas tarifas). Etihad similar pero menos amplio. EK edge" },
      { label: "Hub experience", aScore: 9, bScore: 8, winner: "a", note: "DXB Terminal 3 (Emirates dedicado) gigantesco pero eficiente. AUH terminal mejor 2024 tras renovación. DXB más destinos para conexiones" },
      { label: "Conexión Australia/Nueva Zelanda", aScore: 9, bScore: 7, winner: "a", note: "Emirates SYD/MEL/AKL diarios desde DXB. Etihad SYD/MEL pero menos frecuencia. Emirates dominante Oceanía" },
      { label: "Acumulación millas (programas partner)", aScore: 7, bScore: 9, winner: "b", note: "Skywards parte limitada con Qantas. Etihad Guest partner con AF-KLM Flying Blue (transferible) + American Airlines. EY más versátil para acumular en Europa" },
    ],
    verdict: "Emirates gana en red mundial (140+ destinos), Dubai Stopover programme más amplio, conexiones Oceanía dominantes (SYD/MEL/AKL diarios). Etihad gana en producto Business/First class luxury (Apartment/Residence), error fares más frecuentes Europa-Asia (€280-400 rt), partnership con Air France-KLM Flying Blue (millas transferibles a Skyteam). Para Asia + Australia + stopover Dubai → Emirates. Para Maldivas/Asia + producto premium + acumular millas en Europa → Etihad. Ambos compiten en Bali, Tokio, Bangkok con margen €30-80 según mes.",
    pickA: ["Oceanía (SYD, MEL, AKL via DXB)", "Stopover Dubai gratis 96h", "Red África Subsahariana", "A380 cabin experience (bar a bordo)"],
    pickB: ["Producto Apartment/Residence", "Error fares más frecuentes Asia", "Acumular Flying Blue (transfer AF-KL)", "Maldivas (MLE via AUH directo)"],
  },
  {
    slug: "easyjet-vs-vueling-bcn-paris",
    title: "easyJet vs Vueling: ¿cuál desde Barcelona a París?",
    description: "Comparativa easyJet vs Vueling en ruta BCN-CDG/ORY. Precios, frecuencias, equipaje y experiencia a bordo.",
    routeContext: "BCN → París (CDG/ORY)",
    a: {
      code: "U2",
      name: "easyJet",
      country: "Reino Unido",
      emoji: "🟧",
      category: "low-cost",
      tagline: "Aeropuertos primarios (CDG en lugar de BVA), confort medio",
      mainHub: "LGW",
      typicalPriceEur: 95,
      minErrorFareEur: 28,
      loyaltyProgram: "Sin programa formal",
    ...
    b: {
      ...
      emoji: "🟡",
      category: "low-cost",
      tagline: "Hub BCN, mayor red europea desde Cataluña, IAG group",
      mainHub: "BCN",
      typicalPriceEur: 95,
      minErrorFareEur: 28,
      loyaltyProgram: "Iberia Plus (Avios)",
    ...
    criteria: [
      { label: "Frecuencias BCN-CDG diarias", aScore: 7, bScore: 9, winner: "b", note: "Vueling 4-6 vuelos/día BCN-ORY. easyJet 2-3/día BCN-CDG. Vueling más horarios" },
      { label: "Precio ida típica anticipado", aScore: 7, bScore: 7, winner: "tie", note: "Ambos €28-95 según anticipación. Vueling ligeramente más estable, easyJet más volátil" },
      { label: "Bolso pequeño cabina", aScore: 8, bScore: 7, winner: "a", note: "easyJet 45×36×20 (más generoso). Vueling 40×20×30 (más estrecho). easyJet edge confort" },
      { label: "Programa fidelidad", aScore: 4, bScore: 8, winner: "b", note: "easyJet sin programa real. Vueling Iberia Plus = Avios canjeables en BA/IB/QR/JL. Vueling edge clear para frequent flyer" },
      { label: "Cancelaciones operativas 2025", aScore: 6, bScore: 7, winner: "b", note: "easyJet huelgas FR/UK afectan ratio. Vueling post-IAG mejor operación (menos cancelaciones)" },
      { label: "Hands Free / Servicio extra", aScore: 9, bScore: 6, winner: "a", note: "easyJet Hands Free €4 = facturan trolley gratis si solo bolso pequeño. Vueling sin equivalente" },
      { label: "Asignación de asiento Basic", aScore: 6, bScore: 7, winner: "b", note: "easyJet Basic asigna random (puede separar familia). Vueling Basic random pero política IAG menos agresiva" },
    ],
    verdict: "Ambas son casi empate en precio para BCN-París. Vueling gana en frecuencias (4-6 vs 2-3/día), programa Iberia Plus Avios (canjeable en oneworld), y operación más estable post-IAG. easyJet gana en confort bolso pequeño (45×36×20), Hands Free service único, y aeropuertos primarios (CDG vs ORY ambos primarios en París, empate). Para residentes Cataluña frequent flyer → Vueling (Avios). Para escapada puntual + bolso amplio → easyJet. Para máxima flexibilidad horario → Vueling (más frecuencias).",
    pickA: ["Bolso pequeño grande (45×36×20)", "Hands Free service trolley facturado gratis", "No te importa el programa fidelidad", "Prefieres aeropuertos primarios CDG"],
    pickB: ["Más frecuencias diarias BCN-París", "Iberia Plus Avios canjeables (BA/IB/QR/JL)", "Operación más estable post-IAG", "Hub BCN para conexiones europeas"],
  },
  {
    slug: "british-vs-iberia-londres-madrid",
    title: "British Airways vs Iberia: ¿oneworld desde España, cuál es mejor?",
    description: "Comparativa BA vs Iberia (ambas oneworld + IAG). Equipaje, hubs, Avios y conexiones largo radio.",
    routeContext: "España → UK/USA largo radio",
    a: {
      code: "BA",
      name: "British Airways",
      country: "Reino Unido",
      emoji: "🟦",
      category: "full-service",
      tagline: "Bandera UK, hub LHR T5, Club World long-haul",
      mainHub: "LHR",
      typicalPriceEur: 195,
      minErrorFareEur: 65,
      loyaltyProgram: "Avios (oneworld)",
      skytraxStars: 4,
    },
    b: {
      code: "IB",
      ...
      emoji: "🟥",
      category: "full-service",
      tagline: "Bandera ES, hub MAD T4, red Latam más densa Europa",
      mainHub: "MAD",
      typicalPriceEur: 175,
      minErrorFareEur: 58,
      loyaltyProgram: "Iberia Plus (Avios)",
    ...
    criteria: [
      { label: "Equipaje cabina incluido", aScore: 10, bScore: 8, winner: "a", note: "BA permite 23kg combinados cabina en Basic (¡único en EU!). Iberia 10kg cabina. BA edge enorme" },
      { label: "Red largo radio desde España", aScore: 6, bScore: 9, winner: "b", note: "Iberia 25+ destinos Latam directos desde MAD (EZE, GRU, BOG, LIM, MEX, MIA, JFK...). BA solo LHR a Latam (requiere conexión LHR). Iberia dominante" },
      { label: "Red largo radio vía LHR/MAD", aScore: 9, bScore: 8, winner: "a", note: "BA conecta LHR con 200+ destinos mundiales (Asia + África + Oceanía + USA). Iberia 100+ destinos. BA red mundial más amplia" },
      { label: "Producto Business class", aScore: 8, bScore: 8, winner: "tie", note: "BA Club World (lie-flat 1-2-1 nuevo Club Suite). Iberia Business A350 (lie-flat). Ambos comparables, BA Club Suite ligeramente más moderno 2024" },
      { label: "Lounge hub flagship", aScore: 9, bScore: 8, winner: "a", note: "BA Concorde Room LHR T5 (solo First) + Galleries Club. Iberia Velázquez Premium MAD T4 (Business). BA edge en First" },
      { label: "Frecuencia error fares", aScore: 7, bScore: 8, winner: "b", note: "Iberia errors 5-7/año MAD-EZE/JFK Business €380-580. BA errors 4-5/año LHR-Asia Business. Iberia más frecuente para Latam" },
      { label: "Avios canjeables (mismo programa)", aScore: 9, bScore: 9, winner: "tie", note: "BA + IB + Vueling + AerLingus comparten Avios (IAG). Misma cuenta acumula vuelos en ambas. Empate clear" },
    ],
    verdict: "Para destinos Latinoamérica (Argentina, Chile, Cuba, México, Colombia, Perú) Iberia gana fácil — red dominante desde MAD. Para destinos Asia/África/Oceanía vía LHR, British Airways gana — hub mundial. Para vuelos España-UK directos, ambas compiten cabeza a cabeza. BA destaca en bolso 23kg combinados (único EU). Iberia destaca en frecuencia errors fares Latam. Ambas comparten Avios (oneworld + IAG) — puedes acumular en una y redimir en otra sin problema. Para empresa con clientes Latam → Iberia. Para empresa con clientes USA/Asia → British Airways.",
    pickA: ["UK directo (BA MAD-LHR + BCN-LHR)", "USA/Asia/Oceanía vía LHR", "Bolso 23kg combinados cabina (único)", "Lounge Concorde Room First"],
    pickB: ["Latam directo desde MAD (25+ destinos)", "Argentina, Chile, Cuba, México, Colombia", "Errors Business Latam €380-580", "Hub MAD T4 sin necesidad LHR"],
  },
];
